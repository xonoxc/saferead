   ...
   return (
      <View style={[styles.container, { backgroundColor: colors.background }]}>
         ...
         <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
            ...
            >
               <View
                  style={[styles.currentLanguageIcon, { backgroundColor: colors.primary + "15" }]}
               >
            ...
            >
               ...
               <Text style={[styles.noteText, { color: colors.textSecondary }]}>
                  Changing your language will update the app interface. Document analysis is
                  currently available in English, with support for more languages coming soon.
               </Text>
            </Animated.View>
         </ScrollView>
      </View>
