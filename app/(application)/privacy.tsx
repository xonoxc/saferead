    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        >
          ...
          <Text style={[styles.overviewTitle, { color: colors.text }]}>Your Data is Protected</Text>
          <Text style={[styles.overviewDescription, { color: colors.textSecondary }]}>
            We use industry-leading security measures to protect your legal documents and personal
            information. Your privacy is fundamental to our service.
          </Text>
        </Animated.View>
            ...
            >
              ...
              >
                <View style={styles.privacyHeaderLeft}>
                  <View style={[styles.privacyIcon, { backgroundColor: section.color + "15" }]}>
                    <section.icon size={20} color={section.color} />
                  </View>
                  <Text style={[styles.privacyTitle, { color: colors.text }]}>{section.title}</Text>
                </View>
                <ChevronRight
                  size={20}
                  color={colors.textSecondary}
                  style={{
                    transform: [{ rotate: expandedSection === section.id ? "90deg" : "0deg" }],
                  }}
                />
              </TouchableOpacity>

              {expandedSection === section.id && (
                <Animated.View entering={FadeInDown.springify()} style={styles.privacyContent}>
        ...
        <Animated.View entering={FadeInDown.delay(700).springify()} style={styles.section}>
          ...
          {privacyControls.map((control, index) => (
            <Animated.View key={index} entering={FadeInRight.delay(800 + index * 100).springify()}>
              <TouchableOpacity
                style={[
                  styles.controlItem,
                  { backgroundColor: colors.card, borderColor: colors.border },
              ...
              >
                <View style={styles.controlLeft}>
                  <View
                    style={[
                      styles.controlIcon,
                      { backgroundColor: control.danger ? colors.error + "15" : colors.surface },
                    ]}
                  >
                    <control.icon
                      size={20}
